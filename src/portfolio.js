...
const greeting = {
  ...
  portfolio_repository: "https://github.com/Harish1919/masterPortfolio",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Developing highly scalable production ready Desktop App",
        "⚡ Experience of working with Java Swing",
      ],
      softwareSkills: [
        {
    ...
    },
    {
      ...
      skills: [
        "⚡ Building responsive website front end using HTML5,CSS3,Bootstrap",
        "⚡ Creating application backend in Django,Java",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
